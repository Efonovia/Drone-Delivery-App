...
function AdminHome() {
    ...
    return (
        <ErrorBoundary message="Could't get necessary Info. Check your internet and try agin" isError={getStatsQuery.isError} refetch={getStatsQuery.refetch}>
                                ...
                                <div className="row">
                                    <div className="col-lg-3">
                                        <div className="single_analite_content">
                                            ...
                                            <h3>N <span className="counter">{totalIncome}</span> </h3>
                                    ...
                                    <div className="col-lg-3">
                                        <div className="single_analite_content">
                                            ...
                                            <h3><span className="counter">{totalCustomers}</span> </h3>
                                            <div className="d-flex">
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-3">
                                        <div className="single_analite_content">
                                            ...
                                            <h3><span className="counter">{averagePackageWeight || 0}</span> </h3>
                                            <div className="d-flex">
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-3">
                                        <div className="single_analite_content">
                                            ...
                                            <h3><span className="counter">{totalDrones}</span> </h3>
                                            <div className="d-flex">
                                            </div>
                                        </div>
                                    </div>
